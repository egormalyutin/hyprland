...
class CHyprRenderer {
  ...
  private:
    ...
    void renderWorkspaceWindows(PHLMONITOR, PHLWORKSPACE, const Time::steady_tp&, bool renderTiled,
                                bool renderFloating); // renders workspace windows (no fullscreen) (tiled, floating, pinned, but no special)
